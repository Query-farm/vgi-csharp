...
# untouched. Ported verbatim from vgi-go's ci/preprocess-require.awk (this
# rewrite is entirely worker-language-agnostic — it only touches the .test
# files themselves). See ci/README.md.
#
