namespace QueryFarm.Vgi.VersionedWorker;
...
///
/// Duplicated verbatim in <c>QueryFarm.Vgi.VersionedTablesWorker</c> (that sibling fixture's own
/// copy) — each dedicated worker is deliberately small and self-contained; see that project's own
/// copy's doc comment for why they're two separate processes rather than one shared catalog set.
/// </summary>
